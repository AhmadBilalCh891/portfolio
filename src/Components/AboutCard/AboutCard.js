			...
			<Card.Body>
				<blockquote className='blockquote mb-0'>
					<p style={{ textAlign: 'justify' }}>
						Hi Everyone, This is{' '}
						<span className='purple'>Ahmad Bilal </span> a
						...
						<br /> <br />
						<br />⚡ I am MERN Stack developer with 2 years of
						Experience in building web applications. I have
						experience working with
						<span className='purple'>
							{' '}
							TypeScript, JavaScript, NodJs, ExpressJs, FastifyJs,
							Postgres, MongoDb, Elastic Search, Redis, ReactJs &
							Redux.
						</span>
						<br />
						<br />
						<br />⚡ I am a person who coexists with this universe
						creating and solving Problems. In my perspective, truth
